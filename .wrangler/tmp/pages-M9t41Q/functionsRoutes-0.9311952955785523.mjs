...
import { onRequestPost as __api_ubah_password_js_onRequestPost } from "D:\\e-voting\\functions\\api\\ubah-password.js"
...
export const routes = [
    ...
    },
  {
      ...
      method: "POST",
      middlewares: [],
      modules: [__api_ubah_password_js_onRequestPost],
    },
  {
      routePath: "/api/vote",
      mountPath: "/api",
